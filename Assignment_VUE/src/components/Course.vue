<template>
  <div class="container">
    <mdb-container>
        <mdb-card>
            <h3 class="card-header green lighten-1 white-text text-center font-weight-bold text-uppercase py-4">Student Course list</h3>
        </mdb-card>
    </mdb-container>
    <div class="container">
        <mdb-tbl btn responsive striped>
        <mdb-tbl-head class="black lighten-2 white-text text-center font-weight-bold text-uppercase">
            <tr>
                <th>Id</th>
                <th>Course</th>
                <th>Description</th>
        ...
        <mdb-tbl-body class="blue lighten-5 black-text text-center">
            <tr
        ...
        <mdb-container>
            <mdb-row>
                <mdb-col xl="3" md="6" class="mx-auto text-center">
                    <mdb-btn color="blue" @click.native="modal = true">Add</mdb-btn>
                </mdb-col>
            </mdb-row>
